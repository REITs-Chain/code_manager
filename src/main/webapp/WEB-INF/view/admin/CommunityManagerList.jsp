...
<html>
  ...
  <body class="skin-blue sidebar-mini">
				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
				        <h3 class="box-title pull-left"  style="margin-right: 20px;margin-top: 8px">社区管理员管理</h3>
                  		<div class="btn-group btn-group-sm pull-left">
						  <a type="button" class="btn btn-success" href="admin/CommunityManager/edit">新增</a>
						  <a type="button" class="btn btn-warning" href="admin/CommunityManager/list">刷新</a>
						</div>
						<form id="table_form" action="admin/CommunityManager/list" method="post">
    ...
    <script type="text/javascript">
   		...
   		function onNew(){   			
   			var url="admin/CommunityManager/edit";		
   			window.location=url;
   		}
   		function onEdit(id){
   			var url="admin/CommunityManager/edit?";
   		...
   		function onView(id){
   			var url="admin/CommunityManager/view?";
   			url+="id="+id; 			
   			window.location=url;
   		}  
	    ...
	    function doAjaxDelete(id){
	    	$.ajax({
			    url:'admin/admin/CommunityManager/delete',
			    type:'POST', //GET
