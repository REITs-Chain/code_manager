				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">银行卡认证编辑</h3>
				<a type="button" class="btn btn-success" href="admin/BankcardVerif/list">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/BankcardVerif/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="bankCardNum" name="bankCardNum" value="${data.bankCardNum}" class="form-control pull-right"  ww-string />
							<form:errors path="bankCardNum" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="bankName" class="col-sm-2 control-label"></label>
						<div class="col-sm-6 input-group">
							<input type="text" id="bankName" name="bankName" value="${data.bankName}" class="form-control pull-right"  ww-string />
							<form:errors path="bankName" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="idNumber" name="idNumber" value="${data.idNumber}" class="form-control pull-right"  ww-string />
							<form:errors path="idNumber" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							...
							<input type="text" id="verifTime" name="verifTime" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${data.verifTime}'/>" class="form-control pull-right"  ww-datetime />
							<form:errors path="verifTime" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
