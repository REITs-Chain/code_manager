	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					交易_vout_addresses
					<small>交易_vout_addresses面板</small>
				</h1>
			</section>
			<!-- /content Header -->
			<!-- Main content -->
				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
				        <h3 class="box-title pull-left"  style="margin-right: 20px;margin-top: 8px">交易_vout_addresses管理</h3>
                  		<div class="btn-group btn-group-sm pull-left">
						  <a type="button" class="btn btn-success" href="admin/Tx_vout_addresses/edit">新增</a>
						  <a type="button" class="btn btn-warning" href="admin/Tx_vout_addresses/list">刷新</a>
						</div>
						<form id="table_form" action="admin/Tx_vout_addresses/list" method="post">
						        ...
						        <tr >
						            <td style="width:130px">
						            	<div class="btn-group btn-group-xs" style="margin: 0;">
										 <a class="btn btn-primary" href="admin/Tx_vout_addresses/edit?id=${item.id}&state=1"><i class="am-icon-edit" style="margin-right:4px;"></i>修改</a>
										 <a class="btn btn-info" href="admin/Tx_vout_addresses/view?id=${item.id}"><i class="am-icon-edit"></i>查看</a>
										 <a class="btn btn-danger" href="admin/Tx_vout_addresses/delete?id=${item.id}" onclick="return onDelete(${item.id})"><i class="am-icon-remove" style="margin-right:4px;"></i>删除</a>
										</div>
						            </td>
