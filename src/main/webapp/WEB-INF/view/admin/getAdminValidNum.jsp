				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">获取手机验证码</h3>
				<!-- <a type="button" class="btn btn-success" href="admin/Admin/list">返回</a> -->
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Admin/getAdminValidNum" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						<label for="phoneNum" class="col-sm-2 control-label"></label>
						<div class="col-sm-6 input-group">
							<input type="text" id="phoneNum" name="phoneNum" value="${phoneNum}" class="form-control pull-right" readonly="readonly" ww-integer />
							<form:errors path="phoneNum" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
						</div>
                  		<div class="box-footer">
                    			<button type="submit" id="wwsubmit" class="btn btn-primary">发送手机验证码</button>
                  		</div>
                	</form:form>
                	<!-- /panel-body -->
                </div>
