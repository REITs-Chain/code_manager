  ...
  <body class="skin-blue sidebar-mini">
				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
				        <h3 class="box-title pull-left"  style="margin-right: 20px;margin-top: 8px">APP应用管理</h3>
                  		<div class="btn-group btn-group-sm pull-left">
						  <a type="button" class="btn btn-success" href="admin/OpenApp/edit">新增</a>
						  <a type="button" class="btn btn-warning" href="admin/OpenApp/list">刷新</a>
						</div>
						<form id="table_form" action="admin/OpenApp/list" method="post">
    ...
    <script type="text/javascript">
	    ...
	    function doAjaxDelete(id){
	    	$.ajax({
			    url:'admin/admin/OpenApp/delete',
			    type:'POST', //GET
