				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">分红地址编辑</h3>
				<a type="button" class="btn btn-success" href="admin/Bonusaddress/list">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Bonusaddress/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						<label for="address" class="col-sm-2 control-label">分红地址</label>
						<div class="col-sm-6 input-group">
