		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<a type="button" class="btn btn-success" href="javascript:history.go(-1);">返回</a>
                	...
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Article/save2" method="post" class="form-horizontal" enctype="multipart/form-data">
                  		<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							...
							<input type="text" id="relaseTime" name="relaseTime" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${data.relaseTime}'/>" class="form-control pull-right"  ww-datetime />
							<form:errors path="relaseTime" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="publisher" class="col-sm-2 control-label">发布人</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="publisher" name="publisher" value="${data.publisher}" class="form-control pull-right"  ww-integer />
							<form:errors path="publisher" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							...
							<input type="file" id="file_photo" name="file_photo"  onchange="WW.AjaxUploadImage('file_photo','photo',100)" />
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="brief" name="brief" value="${data.brief}" class="form-control pull-right"  ww-string />
							<form:errors path="brief" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
