		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<!-- <a type="button" class="btn btn-success" href="admin/Admin/list">返回</a> -->
                	...
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Admin/updatePwd" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						<label for="fpassword" class="col-sm-2 control-label">旧密码</label>
						<div class="col-sm-6 input-group">
							<input type="password" id="fpassword" name="fpassword" value="${data.fpassword}" class="form-control pull-right"  ww-string />
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="password" id="password" name="password" value="${data.password}" class="form-control pull-right"  ww-string />
							<form:errors path="password" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="fpwd" class="col-sm-2 control-label">确认密码</label>
						<div class="col-sm-6 input-group">
							<input type="password" id="fpwd" class="form-control pull-right"  ww-string />
							<form:errors path="fpwd" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
