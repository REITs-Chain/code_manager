				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">APP应用编辑</h3>
				<a type="button" class="btn btn-success" href="javascript:history.go(-1);">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/OpenApp/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						<label for="openUserId" class="col-sm-2 control-label">开放平台用户ID</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="openUserId" name="openUserId" value="${data.openUserId}" class="form-control pull-right"  ww-integer />
							<form:errors path="openUserId" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="appName" class="col-sm-2 control-label">应用名称</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="appName" name="appName" value="${data.appName}" class="form-control pull-right"  ww-string />
							<form:errors path="appName" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="appId" class="col-sm-2 control-label">应用ID</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="appId" name="appId" value="${data.appId}" class="form-control pull-right"  ww-string />
							<form:errors path="appId" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="secure" class="col-sm-2 control-label">密码</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="secure" name="secure" value="${data.secure}" class="form-control pull-right"  ww-string />
							<form:errors path="secure" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
