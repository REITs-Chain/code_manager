				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">社区管理员编辑</h3>
				<a type="button" class="btn btn-success" href="javascript:history.go(-1);">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/CommunityManager/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="communityId" name="communityId" value="${data.communityId}" class="form-control pull-right"  ww-integer />
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="managerType" name="managerType" value="${data.managerType}" class="form-control pull-right"  ww-integer />
							<form:errors path="managerType" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
