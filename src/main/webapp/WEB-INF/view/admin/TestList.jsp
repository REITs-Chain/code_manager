              	...
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
				        <h3 class="box-title pull-left"  style="margin-right: 20px;margin-top: 8px">测试模板管理</h3>
						  ...
						  <a type="button" class="btn btn-default" href="admin/Test/edit">新增</a>
						  <a type="button" class="btn btn-default" href="admin/Test/list">刷新</a>
						</div>
						        ...
						        <tr >
						            <td style="width:130px">
						            	<div class="btn-group btn-group-xs" style="margin: 0;">
										 <a class="btn btn-default" href="admin/Test/edit?id=${item.fid}&state=1"><i class="am-icon-edit" style="margin-right:4px;"></i>修改</a>
										 <a class="btn btn-default" href="admin/Test/edit?id=${item.fid}&state=2"><i class="am-icon-edit"></i>查看</a>
										 <a class="btn btn-default" href="admin/Test/delete?id=${item.fid}" onclick="return onDelete(${item.fid})"><i class="am-icon-remove" style="margin-right:4px;"></i>删除</a>
										</div>
						            </td>
                                    ...
                                    <td>${item.fboolean}</td>
                                    <td>${item._getParent('model.Admin','fselectfix').fname}</td>
