				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">交易_vin编辑</h3>
				<a type="button" class="btn btn-success" href="admin/Tx_vin/list">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Tx_vin/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="vout" name="vout" value="${data.vout}" class="form-control pull-right"  ww-double />
							<form:errors path="vout" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="sequence" class="col-sm-2 control-label"></label>
						<div class="col-sm-6 input-group">
							<input type="text" id="sequence" name="sequence" value="${data.sequence}" class="form-control pull-right"  ww-integer />
							<form:errors path="sequence" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="coinbase" class="col-sm-2 control-label"></label>
						<div class="col-sm-6 input-group">
							<input type="text" id="coinbase" name="coinbase" value="${data.coinbase}" class="form-control pull-right"  ww-string />
							<form:errors path="coinbase" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
