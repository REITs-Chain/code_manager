				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">会员用户实名确认</h3>
						<a type="button" class="btn btn-success" href="admin/User/list">返回</a>
						<c:if test="${data.certificationStatus!=2 }">
							<a type="button" class="btn btn-success" href="admin/User/pass?id=${data.id}">认证通过</a>
							<a type="button" class="btn btn-danger" href="admin/User/deny?id=${data.id}">拒绝认证</a>
		            	</c:if>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
