				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">交易_vout_addresses编辑</h3>
				<a type="button" class="btn btn-success" href="admin/Tx_vout_addresses/list">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Tx_vout_addresses/save" method="post" class="form-horizontal">
                  		<div class="box-body">
