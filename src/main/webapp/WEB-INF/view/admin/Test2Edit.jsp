				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		...
                  		<a title="返回" class="badge bg-green" href="admin/Test2/list">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Test2/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						<label for="ftext" class="col-sm-2 control-label">文本</label>
						<div class="col-sm-6 input-group">
					...
					<div class="form-group">
						<label for="fint" class="col-sm-2 control-label">整数</label>
						<div class="col-sm-6 input-group">
					...
					<div class="form-group">
						<label for="fdouble" class="col-sm-2 control-label">小数</label>
						<div class="col-sm-6 input-group">
					...
					<div class="form-group">
						<label for="fdate" class="col-sm-2 control-label">日期</label>
						<div class="col-sm-6 input-group">
					...
					<div class="form-group">
						<label for="fdatetime" class="col-sm-2 control-label">日期时间</label>
						<div class="col-sm-6 input-group">
							<div class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</div>
					...
					<div class="form-group">
						<label for="fboolean" class="col-sm-2 control-label">布尔</label>
						<div class="col-sm-6 input-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<form:select name="fselectfix" id="fselectfix" path="fselectfix" value="${data.fselectfix}" class="form-control">
                            	<form:option value="1">ww1</form:option>
                            	<form:option value="2">ww2</form:option>
                            </form:select>
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<form:select name="fselectdt" id="fselectdt" path="fselectdt" value="${data.fselectdt}" class="form-control">
                            	<form:option value="w1">ww1</form:option>
                            	<form:option value="w2">ww2</form:option>
                            </form:select>
					...
					<div class="form-group">
						<label for="fueditor" class="col-sm-2 control-label">富文本</label>
						<div class="col-sm-6 input-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							...
							<img src="public/file_list/images/${data.fimage}" id="img_fimage" alt="图片图片" height="150" width="150"/>
							<form:errors path="fimage" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
