				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">开放平台用户编辑</h3>
				<a type="button" class="btn btn-success" href="javascript:history.go(-1);">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/OpenUser/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="phoneNum" name="phoneNum" value="${data.phoneNum}" class="form-control pull-right" readonly="readonly" ww-string />
					...
					<%-- <div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="password" name="password" value="${data.password}" class="form-control pull-right"  ww-string />
							<form:errors path="password" class="input-group-addon wwerror"></form:errors>
						</div>
					</div> --%>
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<form:select name="type" id="type" path="type" value="${data.type}" class="form-control">
                            	<form:option value="0">个人</form:option>
                            	<form:option value="1">企业</form:option>
                            </form:select>
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="realName" name="realName" value="${data.realName}" class="form-control pull-right" readonly="readonly" ww-string />
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="idNum" name="idNum" value="${data.idNum}" class="form-control pull-right" readonly="readonly" ww-string />
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="photo1" name="photo1" value="${data.photo1}" class="form-control pull-right" readonly="readonly" ww-string />
							<img src="${imgUrl}${data.photo1}" alt="证件照片" height="150" width="150"/>
							<form:errors path="photo1" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<%-- <div class="form-group">
						<label for="photo2" class="col-sm-2 control-label">证件照片2</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="photo2" name="photo2" value="${data.photo2}" class="form-control pull-right"  ww-string />
							<form:errors path="photo2" class="input-group-addon wwerror"></form:errors>
						</div>
					</div> --%>
					<div class="form-group">
						<label for="linkMan" class="col-sm-2 control-label">联系人</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="linkMan" name="linkMan" value="${data.linkMan}" class="form-control pull-right" readonly="readonly" ww-string />
							<form:errors path="linkMan" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="linkPhone" class="col-sm-2 control-label">联系人电话</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="linkPhone" name="linkPhone" value="${data.linkPhone}" class="form-control pull-right" readonly="readonly" ww-string />
							<form:errors path="linkPhone" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
