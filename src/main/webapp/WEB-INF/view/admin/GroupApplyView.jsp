			...
			<section class="content">
				...
				<a type="button" class="btn btn-success" href="javascript:history.go(-1);">返回</a>
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<span class="form-control">${data.groupHeadId}</span>
						</div>
					</div>
					<div class="form-group">
						<label for="applyUserId" class="col-sm-2 control-label">申请人ID</label>
						<div class="col-sm-6 input-group">
							<span class="form-control">${data.applyUserId}</span>
						</div>
					</div>
					<div class="form-group">
						<label for="content" class="col-sm-2 control-label">申请内容</label>
						<div class="col-sm-6 input-group">
							<span class="form-control">${data.content}</span>
						</div>
					</div>
					<div class="form-group">
						<label for="groupId" class="col-sm-2 control-label">群组ID</label>
						<div class="col-sm-6 input-group">
							<span class="form-control">${data.groupId}</span>
						</div>
					</div>
					<div class="form-group">
						<label for="applyTime" class="col-sm-2 control-label">申请时间</label>
						<div class="col-sm-6 input-group">
							<span class="form-control"><fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${data.applyTime}'/></span>
						</div>
					</div>
