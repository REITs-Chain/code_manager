				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">钱包地址编辑</h3>
				<a type="button" class="btn btn-success" href="admin/Walletaddress/list">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Walletaddress/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<%-- <div class="form-group">
						<label for="type" class="col-sm-2 control-label">钱包类型</label>
						<div class="col-sm-6 input-group">
							<form:select name="type" id="type" path="type" value="${data.type}" class="form-control">
                            	<form:option value="1">瑞资通</form:option>
                            	<form:option value="2">BTC</form:option>
                            </form:select>
							<form:errors path="type" class="input-group-addon wwerror"></form:errors>
						</div>
					</div> --%>
					<div class="form-group">
						<label for="address" class="col-sm-2 control-label">钱包地址</label>
						<div class="col-sm-6 input-group">
