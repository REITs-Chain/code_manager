	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<a type="button" class="btn btn-success" href="admin/Message/list">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Message/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="userId" name="userId" value="${data.userId}" class="form-control pull-right" readonly="readonly" ww-integer />
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<textarea id="content" name="content" style="width:100%;height:360px;">${data.content}</textarea>
							<form:errors path="content" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="createtime" class="col-sm-2 control-label">时间</label>
						<div class="col-sm-6 input-group">
							<div class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</div>
							<input type="text" id="createtime" name="createtime" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${data.createtime}'/>" class="form-control pull-right" readonly="readonly" ww-datetime />
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="status" name="status" value="${data.status}" class="form-control pull-right" readonly="readonly" ww-integer />
