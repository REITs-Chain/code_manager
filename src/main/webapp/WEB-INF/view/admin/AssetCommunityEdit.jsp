				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">社区编辑</h3>
				<a type="button" class="btn btn-success" href="javascript:history.go(-1);">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/AssetCommunity/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="txt_assetId" name="txt_assetId" value="${data._getParentField("assetId","t_asset","id","name").toString()}" class="form-control pull-right" readonly="readonly" />
                            <input type="hidden" id="assetId" name="assetId" value="${data.assetId}" />
                            <span class="input-group-addon" onclick="lookWin('assetId','t_asset','id','name');"><i class="fa fa-search"></i></span>
