				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">登录日志编辑</h3>
				<a type="button" class="btn btn-success" href="admin/Loginlog/list">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Loginlog/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						<label for="loginTime" class="col-sm-2 control-label">登录时间</label>
						<div class="col-sm-6 input-group">
							<div class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</div>
							<input type="text" id="loginTime" name="loginTime" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${data.loginTime}'/>" class="form-control pull-right"  ww-datetime />
							<form:errors path="loginTime" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="ip" class="col-sm-2 control-label">登录IP地址</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="ip" name="ip" value="${data.ip}" class="form-control pull-right"  ww-string />
							<form:errors path="ip" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="location" class="col-sm-2 control-label">登录位置</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="location" name="location" value="${data.location}" class="form-control pull-right"  ww-string />
							<form:errors path="location" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="status" class="col-sm-2 control-label">登录状态</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="status" name="status" value="${data.status}" class="form-control pull-right"  ww-string />
