				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">系统管理编辑</h3>
				<a type="button" class="btn btn-success" href="admin/Admin/list">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Admin/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						<label for="fnumber" class="col-sm-2 control-label">用户编号</label>
						<div class="col-sm-6 input-group">
					...
					<div class="form-group">
						<label for="fname" class="col-sm-2 control-label">用户名</label>
						<div class="col-sm-6 input-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="fpassword" name="fpassword" value="${data.fpassword}" class="form-control pull-right"  ww-string />
							<form:errors path="fpassword" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="flevel" class="col-sm-2 control-label">等级</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="flevel" name="flevel" value="${data.flevel}" class="form-control pull-right"  ww-string />
							<form:errors path="flevel" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="fcreatetime" class="col-sm-2 control-label">创建时间</label>
						<div class="col-sm-6 input-group">
							<div class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</div>
							<input type="text" id="fcreatetime" name="fcreatetime" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${data.fcreatetime}'/>" class="form-control pull-right"  ww-datetime />
							<form:errors path="fcreatetime" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="fnote" class="col-sm-2 control-label">备注</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="fnote" name="fnote" value="${data.fnote}" class="form-control pull-right"  ww-string />
							<form:errors path="fnote" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="fclose" class="col-sm-2 control-label">禁用</label>
						<div class="col-sm-6 input-group">
							<form:checkbox path="fclose" value="${data.fclose}" class="flat-red" style="margin-top: 10px;"/>
							<form:errors path="fclose" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
