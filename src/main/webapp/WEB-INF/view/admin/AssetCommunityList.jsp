...
<html>
  ...
  <body class="skin-blue sidebar-mini">
				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
				        <h3 class="box-title pull-left"  style="margin-right: 20px;margin-top: 8px">社区管理</h3>
                  		<div class="btn-group btn-group-sm pull-left">
						  <a type="button" class="btn btn-success" href="admin/AssetCommunity/edit">新增</a>
						  <a type="button" class="btn btn-warning" href="admin/AssetCommunity/list">刷新</a>
						</div>
						<form id="table_form" action="admin/AssetCommunity/list" method="post">
                		...
                		<table id="table_list" class="table table-striped table-bordered table-condensed">
						    ...
						    <tbody>
						        ...
						        <tr >
                                    ...
                                    <td>${item._getParentField("assetId","t_asset","id","name").toString()}</td>
    ...
    <script type="text/javascript">
   		...
   		function onNew(){   			
   			var url="admin/AssetCommunity/edit";		
   			window.location=url;
   		}
   		function onEdit(id){
   			var url="admin/AssetCommunity/edit?";
   		...
   		function onView(id){
   			var url="admin/AssetCommunity/view?";
   			url+="id="+id; 			
   			window.location=url;
   		}  
	    ...
	    function doAjaxDelete(id){
	    	$.ajax({
			    url:'admin/admin/AssetCommunity/delete',
			    type:'POST', //GET
