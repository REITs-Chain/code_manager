				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
				        <h3 class="box-title pull-left"  style="margin-right: 20px;margin-top: 8px">分红地址管理</h3>
                  		<div class="btn-group btn-group-sm pull-left">
						  <a type="button" class="btn btn-success" href="admin/Bonusaddress/edit">新增</a>
						  <a type="button" class="btn btn-warning" href="admin/Bonusaddress/list">刷新</a>
						</div>
						<form id="table_form" action="admin/Bonusaddress/list" method="post">
						        ...
						        <tr >
						            <td style="width:130px">
						            	<div class="btn-group btn-group-xs" style="margin: 0;">
										 <a class="btn btn-primary" href="admin/Bonusaddress/edit?id=${item.id}&state=1"><i class="am-icon-edit" style="margin-right:4px;"></i>修改</a>
										 <a class="btn btn-info" href="admin/Bonusaddress/view?id=${item.id}"><i class="am-icon-edit"></i>查看</a>
										 <a class="btn btn-danger" href="admin/Bonusaddress/delete?id=${item.id}" onclick="return onDelete(${item.id})"><i class="am-icon-remove" style="margin-right:4px;"></i>删除</a>
										</div>
						            </td>
