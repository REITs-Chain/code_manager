				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">加入组申请编辑</h3>
				<a type="button" class="btn btn-success" href="javascript:history.go(-1);">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/GroupApply/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						<label for="status" class="col-sm-2 control-label">状态：0--通过，1--未通过，2--待审核</label>
						<div class="col-sm-6 input-group">
					...
					<div class="form-group">
						<label for="groupHeadId" class="col-sm-2 control-label">群主ID</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="groupHeadId" name="groupHeadId" value="${data.groupHeadId}" class="form-control pull-right"  ww-integer />
							<form:errors path="groupHeadId" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="applyUserId" class="col-sm-2 control-label">申请人ID</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="applyUserId" name="applyUserId" value="${data.applyUserId}" class="form-control pull-right"  ww-integer />
							<form:errors path="applyUserId" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="content" class="col-sm-2 control-label">申请内容</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="content" name="content" value="${data.content}" class="form-control pull-right"  ww-string />
							<form:errors path="content" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="groupId" class="col-sm-2 control-label">群组ID</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="groupId" name="groupId" value="${data.groupId}" class="form-control pull-right"  ww-integer />
							<form:errors path="groupId" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							...
							<input type="text" id="applyTime" name="applyTime" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${data.applyTime}'/>" class="form-control pull-right"  ww-datetime />
							<form:errors path="applyTime" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
