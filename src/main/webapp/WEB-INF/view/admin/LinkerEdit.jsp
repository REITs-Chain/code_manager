				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">联系人信息编辑</h3>
				<a type="button" class="btn btn-success" href="admin/Linker/list">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Linker/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="id" name="id" value="${data.id}" class="form-control pull-right" readonly="readonly" ww-string />
					...
					<div class="form-group">
						<label for="linkerName" class="col-sm-2 control-label">名称</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="linkerName" name="linkerName" value="${data.linkerName}" class="form-control pull-right"  ww-string />
							<form:errors path="linkerName" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="linkerAddress" class="col-sm-2 control-label">钱包地址</label>
						<div class="col-sm-6 input-group">
							<input type="text" id="linkerAddress" name="linkerAddress" value="${data.linkerAddress}" class="form-control pull-right"  ww-string />
							<form:errors path="linkerAddress" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
