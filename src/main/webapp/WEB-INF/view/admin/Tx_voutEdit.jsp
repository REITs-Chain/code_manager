				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">交易_vout编辑</h3>
				<a type="button" class="btn btn-success" href="admin/Tx_vout/list">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/Tx_vout/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="rootAddress" name="rootAddress" value="${data.rootAddress}" class="form-control pull-right"  ww-string />
							<form:errors path="rootAddress" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="assetid" class="col-sm-2 control-label"></label>
						<div class="col-sm-6 input-group">
							<input type="text" id="assetid" name="assetid" value="${data.assetid}" class="form-control pull-right"  ww-integer />
							<form:errors path="assetid" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="value" class="col-sm-2 control-label"></label>
						<div class="col-sm-6 input-group">
							<input type="text" id="value" name="value" value="${data.value}" class="form-control pull-right"  ww-double />
							<form:errors path="value" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="vout_n" class="col-sm-2 control-label"></label>
						<div class="col-sm-6 input-group">
							<input type="text" id="vout_n" name="vout_n" value="${data.vout_n}" class="form-control pull-right"  ww-integer />
							<form:errors path="vout_n" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						<label for="type" class="col-sm-2 control-label"></label>
						<div class="col-sm-6 input-group">
							<input type="text" id="type" name="type" value="${data.type}" class="form-control pull-right"  ww-string />
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="address" name="address" value="${data.address}" class="form-control pull-right"  ww-string />
							<form:errors path="address" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
