				...
				<!-- panel -->
              	<div class="box box-primary">
                	...
                	<div class="box-header with-border">
                  		<h3 class="box-title">用户风险评估编辑</h3>
				<a type="button" class="btn btn-success" href="admin/UserRisk/list">返回</a>
                	</div>
                	<!-- /panel-header -->
                	<!-- panel-body -->
                	<form:form commandName="data" id="form1" action="admin/UserRisk/save" method="post" class="form-horizontal">
                  		<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<input type="text" id="score" name="score" value="${data.score}" class="form-control pull-right"  ww-integer />
							<form:errors path="score" class="input-group-addon wwerror"></form:errors>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							<form:select name="type" id="type" path="type" value="${data.type}" class="form-control">
                            	<form:option value="0">保守型</form:option>
                            	<form:option value="1">稳健型</form:option>
                            	<form:option value="2">积极型</form:option>
                            </form:select>
					...
					<div class="form-group">
						...
						<div class="col-sm-6 input-group">
							...
							<input type="text" id="time" name="time" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${data.time}'/>" class="form-control pull-right"  ww-datetime />
