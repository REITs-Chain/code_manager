...
public class SmsUtil_hk {
	...
	public static boolean sendVerifyNum(String phone,String msg){
		...
		try {
			...
			e.printStackTrace();
			Log log=LogFactory.getLog(SmsUtil_hk.class);
